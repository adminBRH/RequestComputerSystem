<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RecordDisbursementMoney.aspx.cs" Inherits="RequestComputerSystem.Disbursement.RecordDisbursementMoney" %>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="text-center">
                                                             <table width="100%" border="0">
                                                                    แบบบันทึกการขออนุมัติเบิก-จ่ายเงิน <br /> Internal Routing Slip
                                                             </table>
                                                        </div>
                                                    </td>                               
                                            </tr>
                                                        ...
                                                        <table width="100%" border="0">
                                                            <tr>
                                                                <td class="text-left">
                                                                    ...
                                                                    <br /><br />
                                                                    &nbsp;&nbsp;<label ID="lbl_from_th">จาก</label><label ID="lbl_from_en" hidden="hidden">From</label>...<asp:Label id="lbl_from" ForeColor="Black" Text="" runat="server"></asp:Label>... &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                
                                                                </td>  
                                                                <td class="text-left">
                                                                    <br />
                                                                    &nbsp;&nbsp;<label ID="lbl_date_th">วันที่</label><label ID="lbl_date_en" hidden="hidden">Date</label>...<asp:Label id="lbl_date" ForeColor="Black" Text="" runat="server"></asp:Label>...
                                                                    <br /><br />
                                                    ...
                                                    <div class="col-12 mx-auto" style="border:1px; border:">
                                                        <table width="100%" border="0">
                                                           <tr>
                                                            ...
                                                            <td class="">                                   
                                                               <label ID="lbl_money_th">จำนวนเงิน</label><label ID="lbl_money_en" hidden="hidden">Money</label>...<asp:Label id="lbl_money" ForeColor="Black" Text="" runat="server"></asp:Label>... บาท                                    
                                                            </td>
                                                           </tr>
                                                         </table>
                                                    </div>
                                                ...
                                                <td colspan="2">
                                                    <div class="col-12 mx-auto" style="border:1px; border:">
                                                        <table width="100%" border="0">
                                                           <tr>
                                                            <td class="">
                                                                &nbsp;&nbsp;<input type="checkbox" id="rd_invoice" disabled runat="server"/>&nbsp;<label ID="lbl_invoice_th">ใบแจ้งหนี้ จำนวน</label><label ID="lbl_invoice_en" hidden="hidden">Invoice</label>...<asp:Label id="lbl_invoice" ForeColor="Black" Text="
                                                                    " runat="server"></asp:Label>...ฉบับ<br />
                                                                &nbsp;&nbsp;<input type="checkbox" id="rd_detail" disabled runat="server"/>&nbsp;<label ID="lbl_detail_th">รายละเอียดของโครงการ จำนวน</label>...<asp:Label id="lbl_detail" ForeColor="Black" Text="" runat="server"></asp:Label>.... แผ่น
                                                                <br />                                                  
                                                            </td>
                                                            <td class="">                                   
                                                               &nbsp;&nbsp;<input type="checkbox" id="rd_bill" disabled runat="server"/>&nbsp;<label ID="lbl_bill_th">ใบเสร็จรับเงิน จำนวน</label><label ID="lbl_bill_en" hidden="hidden">Bill</label>.....<asp:Label id="lbl_bill" ForeColor="Black" Text="" runat="server"></asp:Label>..... ฉบับ  
                                                                <br />
                                                                &nbsp;&nbsp;<input type="checkbox" id="rd_other" disabled runat="server"/>&nbsp;<label ID="lbl_other_th">อื่นๆ</label><label ID="lbl_other_en" hidden="hidden">Other</label>.....<asp:Label id="lbl_other" ForeColor="Black" Text=" " runat="server"></asp:Label>.....
                                                                <br />
                                                ...
                                                <td colspan="2">
                                                    <div class="col-12 mx-auto" style="border:1px; border:">
                                                        <table width="100%" border="0">
                                                           <tr>
                                                            <td class="">
                                                                &nbsp;&nbsp;&nbsp;<label ID="lbl_dtmore_th"></label><label ID="lbl_dtmore_en" hidden="hidden">More Detail</label> รายละเอียดเพิ่มเติม<br />
                                                                     <asp:Label id="lbl_dtmore" ForeColor="Black" Text="" runat="server">....................................................................................................................................................................................................................................<br />
                                                                         ....................................................................................................................................................................................................................................<br />
                                                                         ....................................................................................................................................................................................................................................<br />
                                                                         ....................................................................................................................................................................................................................................<br />
                                                                    </asp:Label>
                                                        ...
                                                        <table width="100%" border="1">
                                                            ...
                                                            <tr>
                                                             ...
                                                             <td class="text-center">    
                                                                 <div class="mt-2">
                                                                     <br><br />
                                                                      &nbsp;&nbsp;&nbsp;<label ID="lbl_ceo_th"></label><label ID="lbl_ceo_en" hidden="hidden">CEO</label><asp:Label id="lbl_ceo" ForeColor="Black" 
                                                                      Text=".................................................." runat="server"></asp:Label><br />
                                                                                  &nbsp;&nbsp;&nbsp;(..................................................)<br />
              ...
              <ContentTemplate>
                 ...
                 <%-- <div class="form-group text-left">
                  ...
                  <div class="form-group text-left">
                    <label id="lbl_deptcode_md" style="font-size: 25px;"></label>
                      ...
                      <asp:UpdatePanel ID="UpdatePanel_dept" runat="server">
                         ...
                         <asp:DropDownList ID="ip_deptcode1" AutoPostBack="true" OnSelectedIndexChanged="ip_deptcode1_SelectedIndexChanged"  runat="server">
                          ...
                          <Triggers>
                              <asp:AsyncPostBackTrigger ControlID="ip_deptcode1" EventName="selectedindexchanged" />
                          </Triggers>
                          </asp:UpdatePanel>
                  ...
                  <div class="form-group text-left col-5">
                    ...
                    <input type="number" class="form-control" value="" id="ip_amount_n" runat="server" />
                  </div>
                  <div class="form-group text-left col-5">
                    <label id="lbl_invoice_md" style="font-size: 25px;">ใบแจ้งหนี้ จำนวน</label>
                    <input type="number" class="form-control" value="" id="ip_invoice_n" runat="server" />
                  </div>
                  <div class="form-group text-left col-5">
                    <label id="lbl_bill_md" style="font-size: 25px;">ใบเสร็จรับเงิน จำนวน </label>
                    <input type="number" class="form-control" value="" id="ip_bill_n" runat="server" />
                  </div>
                  <div class="form-group text-left col-5">
                    <label id="lbl_detailproject_md" style="font-size: 25px;">รายละเอียดของโครงการ จำนวน</label>
                    <input type="text" class="form-control" value="" id="ip_detailproject" runat="server" />
                  </div>
                  <div class="form-group text-left col-8">
                  ...
                  <div class="form-group text-left">
                    ...
                    <textarea id="ip_moredetails" class="form-control" runat="server"></textarea>
                  </div>
                  <div class="form-group text-left col-8">
              ...
              <script>
                  function btnok() {
                     ...
                     <%-- var ipDate = document.getElementById('<%= ip_date.ClientID %>')--%>
                      var ipSubmitC = document.getElementById('<%= ip_deptcode1.ClientID %>')
                      var ipDeptCode = document.getElementById('<%= ip_deptcode1.ClientID %>')
                      var DeptName = document.getElementById('<%= txtH_dept.ClientID %>')

                      var ipAPmoney = document.getElementById('<%= ip_apmoney.ClientID %>')
                      var ipAmout = document.getElementById('<%= ip_amount_n.ClientID %>')
                      var ipInvoice = document.getElementById('<%= ip_invoice_n.ClientID %>')
                      var ipBill = document.getElementById('<%= ip_bill_n.ClientID %>')
                      var ipDetailP = document.getElementById('<%= ip_detailproject.ClientID %>')
                      var ipOther = document.getElementById('<%= ip_other.ClientID %>')
                      var ipMoreDetail = document.getElementById('<%= ip_moredetails.ClientID %>')
                      ...
                      var lblInvoice = document.getElementById('<%= lbl_invoice.ClientID %>')
                      var lblBill = document.getElementById('<%= lbl_bill.ClientID %>')
                      var lblDetailP = document.getElementById('<%= lbl_detail.ClientID %>')
                      ...
                      if (ipTo.value == '' || ipFrom.value == '' || ipSubmitC.value == '' || ipDeptCode.value == '') {
                          ...
                          lblInvoice.innerText = ' ' + ipInvoice.value;
                          lblBill.innerText = ' ' + ipBill.value;
                          lblDetailP.innerText = ' ' + ipDetailP.value;
